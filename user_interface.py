...
class UserInterface:
    ...
    def draw_background(self):
        pygame.draw.rect(self.WIN, (53, 59, 179), (0, 0, self.WIDTH, self.HEIGHT), width=2)
    ...
    def button_init(self):
        ...
        velocity_button = Button(plus_button.image.get_rect().topright[0] + 30, 10,
                                 pygame.image.load("buttons/velocity_field.png"),
                                 "velocity")
        ...
        focus_info_button = Button(minus_button.rect.topright[0] + 10, 10, pygame.image
                                   .load("buttons/info_button.png"), "focus_info")
